...
POSTGRES_DB="self-host-next-app"
SECRET_KEY="mysecretpassword" 
NEXT_PUBLIC_SAFE_KEY="mysecretpassword"
DOMAIN_NAME="next-self-host.short4u.in" 
EMAIL="arunprapati1091@gmail.com"

# Script Vars
REPO_URL="https://github.com/arunkumar201/nextjs-self-host-starter.git"
APP_DIR=~/myapp
